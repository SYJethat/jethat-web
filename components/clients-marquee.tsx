...
const ClientsMarqueeSection = () => {
  ...
  return (
    <section id="clients" className="py-16 bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-gray-900 dark:via-black dark:to-gray-800 overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className="inline-flex p-2 rounded-lg bg-gradient-to-r from-[#FF8C00] to-[#FFB300] mb-2">
                  <Icon className="w-5 h-5 text-white" />
                </div>
                <div className="text-2xl font-bold bg-gradient-to-r from-[#FF8C00] to-[#FFB300] bg-clip-text text-transparent">
                  {stat.value}
                </div>
          ...
          >
            ...
            >
              {duplicatedClients.map((client, index) => (
                ...
                >
                  <div className="relative bg-white dark:bg-gray-900/50 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-[#FF8C00] transition-all duration-300 hover:shadow-xl hover:shadow-[#FF8C00]/20 w-40 h-32 flex flex-col items-center justify-center">
                    {/* Logo */}
