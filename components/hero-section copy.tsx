    ...
    <div className="relative">
      ...
      >
        ...
        <div className="absolute   inset-0 flex items-center justify-center overflow-hidden">
          <div className="relative w-full  inset-0 bg-opacity-30 filter backdrop-blur-sm max-w-[90%]  h-118 mt-4 border border-primary/20 rounded-lg">
            ...
            <div className="relative hidden md:block">
              <div className="relative w-full h-96 flex items-center justify-center">
                ...
                <div className="relative w-64 h-64">
                  ...
                  {/* Spiral Orbiting Elements */}
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-1">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Lock className="w-4 h-4 text-primary" />अनुक्षणं 
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-2">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Zap className="w-4 h-4 text-primary" /> रक्षामहे
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-3">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Brain className="w-4 h-4 text-primary" />अनुक्षणं 
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-4">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Cpu className="w-4 h-4 text-primary" /> रक्षामहे
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-5">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Key className="w-4 h-4 text-primary" />अनुक्षणं
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-6">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Network className="w-4 h-4 text-primary" /> रक्षामहे
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-7">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Server className="w-4 h-4 text-primary" />अनुक्षणं 
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-8">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Eye className="w-4 h-4 text-primary" />रक्षामहे
                    </div>
                  </div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-spiral-8">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Eye className="w-4 h-4 text-primary" />अनुक्षणं 
                    </div>
                  </div>
                  ...
                  <div className="absolute top-1/7 right-1/2 transform translate-x-1/4 -translate-y-1/5 animate-orbit-delayed">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Brain className="w-4 h-4 text-primary" /> अनुक्षणं
                    </div>
                  </div>
                  <div className="absolute top-1/8 left-5 transform -translate-x-1/7 -translate-y-1/2 animate-orbit-delayed-reverse">
                    <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                      <Cpu className="w-4 h-4 text-primary" />  रक्षामहे
                    </div>
                  </div>
