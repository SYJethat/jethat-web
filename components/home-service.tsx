  ...
  return (
    <section id="services" className="py-16 bg-gray-100 dark:bg-secondary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 dark:text-white">Our Services</h2>
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-text mb-4 animate-fade-in" style={{ }}>
